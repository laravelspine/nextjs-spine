...
export default function Topbar() {
  ...
  return (
    <header className="topbar flex h-14 shrink-0 items-center justify-between border-b border-line-soft bg-surface px-6">
      <div className="topbar__title flex items-center gap-2 text-sm">
