...
import { ModuleWidgets } from "@/app/components/ModuleWidgets";
...
/**
 * /dashboard — halaman dashboard core. Widget area kanan diisi oleh:
 * (1) widget modul backend (ModuleWidgets — registry /modules/extensions),
 * (2) widget UI-extension dari modul frontend (dashboard.widgets).
 * Keduanya DATANG DARI REGISTRY — bukan hardcoded di halaman ini.
 */
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        />
        <StatCard label="Tags" value={tags.count ?? "—"} hint="GET /api/v1/tags" />
